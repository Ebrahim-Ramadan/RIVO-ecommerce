      ...
      {images[imageIndex] && (
        ...
        {images.length > 1 ? (
          <div className="absolute bottom-2 md:bottom-[15%] flex w-full justify-center">
            <div className="mx-auto flex h-11 items-center rounded-full border border-white bg-neutral-50/80 text-neutral-300 backdrop-blur dark:border-black dark:bg-neutral-900/80">
              <Link
